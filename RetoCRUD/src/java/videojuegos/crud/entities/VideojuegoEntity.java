...
@NamedQueries({
    @NamedQuery(
            name = "ConsultaTitulo",
            query = "SELECT v FROM VideojuegoEntity v WHERE v.titulo = :titulo"
    ),
    @NamedQuery(
            name = "ConsultaFechaInicio",
            query = "SELECT v FROM VideojuegoEntity v WHERE v.fechaLanzamiento < :fechaInicio"
    ),
    @NamedQuery(
            name = "ConsultaFechaFin",
            query = "SELECT v FROM VideojuegoEntity v WHERE v.fechaLanzamiento > :fechaFin"
    ),
    @NamedQuery(
            name = "ConsultaEntreFechas",
            query = "SELECT v FROM VideojuegoEntity v WHERE v.fechaLanzamiento BETWEEN :fechaInicio AND :fechaFin"
    )
})
